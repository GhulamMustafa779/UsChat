    ...
    chatParticipant &&
      ...
      <div className="h-100 w-100 border-b-2 border-gray-100 shadow-sm">
        <div className=" flex items-center gap-3 h-full p-3">
          <Avatar src={chatParticipant?.profilePhoto} size="" online={onlineUsers?.includes(chatParticipant?._id)} />
          <h3 className="font-medium text-gray-500">{chatParticipant?.fullName}</h3>
        </div>
      </div>
